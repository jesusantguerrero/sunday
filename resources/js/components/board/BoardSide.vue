<template>
  <div>
        ...
        <div class="mt-2 text-gray-500 flex rounded overflow-hidden" v-if="!showAdd">
             <button
        ...
        <div class="mt-2 text-gray-500 flex rounded overflow-hidden" v-if="showAdd">
            <input type="text" class="form-control p-2 w-full" placeholder="Add board name" v-model="boardName" ref="input" @blur="showAdd=false">
